...
def main():
    st.title("Stock Market Dashboard & Simple Stock Summary")

    menu = st.sidebar.selectbox("Choose an Option", ["Upload Stock Data & Analyze", "Simple Stock Summary AI"])

    if menu == "Upload Stock Data & Analyze":
    ...
    elif menu == "Simple Stock Summary AI":
